...
# Apply eastmoney NID patch globally if available
...
def _apply_patch():
    ...
    if _EASTMONEY_PATCHED:
        return
    try:
        # Find project root (three levels up: _alphasift/alphasift/snapshot.py → root/)
        ...
        logger.info("Eastmoney patch applied (alphasift)")
    except Exception:
        pass
